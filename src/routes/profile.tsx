...
export const Route = createFileRoute("/profile")({
  head: () => ({
    meta: [
      { title: "My Profile — Bladeroom" },
      { name: "description", content: "Manage your Bladeroom account details." },
    ],
  }),
...
function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-lg px-5 py-16 space-y-8">
      {/* Header */}
      ...
      <div>
        ...
        {profileLoading ? (
          ...
          >
            ...
            <div>
              <Label>Role</Label>
              <div className="mt-1.5 flex items-center gap-2 rounded-md border border-border px-3 py-2">
                ...
                <span className="ml-auto text-xs text-muted-foreground">
                  {isOwner
                    ? "You can manage shops and bookings"
                    : "You can browse shops and book appointments"}
                </span>
              </div>
            </div>
